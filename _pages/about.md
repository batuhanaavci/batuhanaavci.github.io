...
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 20px; border-radius: 10px; color: white; margin: 25px 0; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
  <h3 style="margin-top: 0; color: white;">🚁 Current Research</h3>
  <p style="margin-bottom: 0;">Teaching swarms of drones to work together for monitoring large-scale traffic networks in real-time — exploring scalable multi-agent learning and adaptive control.</p>
</div>
...
<div style="text-align: center; font-style: italic; color: #666; margin-top: 30px;">
  Interested in collaboration or want to chat about autonomous systems? Feel free to reach out! 😊
</div>
